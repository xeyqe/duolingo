...
(function() {
    ...
    function tempAlert(str1,str2,str3) {
        ...
        el.setAttribute("style","padding-left: 0.3em;padding-right: 0.3em;right:3%;" +
        ...
        $(el).on("click", ()=>{
            if (document.querySelector('#tempAlert').style.border == "") {
                ...
                $('#tempAlert').fadeOut(1000, function() { $(this).remove(); el = null });
            }});
    }
    ...
    function keyboardShortcuts() {
        ...
        for (var i=0; i<list.length; i++) {
            ...
            list[i].childNodes[0].querySelector('span').innerText = listOfChar[i];
            list[i].childNodes[0].querySelector('span').style.display = 'block';
        }

        document.onkeyup = function(e) {
            if (listOfCode.includes(e.which)) {
                var index = listOfCode.indexOf(e.which);
                var char = listOfChar[index];
